...
@Component({
  selector: 'app-transport-express-visitor',
  templateUrl: './transport-express-visitor.component.html',
  styleUrls: ['./transport-express-visitor.component.css']
})
export class TransportExpressVisitorComponent implements OnInit {
  imageToShow: any;
...
//*/
  ...
  checkValidDemand(){
    if(this.transport.nomEntreprise!=null && this.transport.nomEntreprise.length>0 &&
