...
@Component({
  selector: 'app-calculer-express',
  templateUrl: './calculer-express.component.html',
  styleUrls: ['./calculer-express.component.css']
})
export class CalculerExpressComponent implements OnInit {
...
//*/
  ...
  towing=true; // false : dont need towing, true: need towing
  calculateDistance=false; // false : dont need calculate distance, true: need calculate
